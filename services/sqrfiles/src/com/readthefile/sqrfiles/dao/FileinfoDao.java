...
package com.readthefile.sqrfiles.dao;
...
/**
 * Specifies methods used to obtain and modify Fileinfo related information
 * which is stored in the database.
 */
@Repository("sqrfiles.FileinfoDao")
public class FileinfoDao extends WMGenericDaoImpl<Fileinfo, Integer> {

    @Autowired
    @Qualifier("sqrfilesTemplate")
    private HibernateTemplate template;

    @Autowired
    @Qualifier("sqrfilesWMQLTypeHelper")
