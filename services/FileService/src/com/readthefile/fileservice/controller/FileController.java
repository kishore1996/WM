...
package com.readthefile.fileservice.controller;
...
import com.readthefile.fileservice.FileService;
import com.readthefile.fileservice.FileService.FileUploadResponse;
import com.readthefile.fileservice.FileService.WMFile;
...
public class FileController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @RequestMapping(value = "/newfilecontent", method = RequestMethod.GET)
    public String newfilecontent(@RequestParam(value = "file", required = false) String file) throws Exception {
        return fileService.newfilecontent(file);
    }

    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @RequestMapping(value = "/sampleJavaOperation", method = RequestMethod.GET)
    public String sampleJavaOperation(@RequestParam(value = "file", required = false) String file, @RequestParam(value = "relativePath", required = false) String relativePath, @RequestParam(value = "returnName", required = false) String returnName) throws Exception {
        return fileService.sampleJavaOperation(file, relativePath, returnName);
    }
